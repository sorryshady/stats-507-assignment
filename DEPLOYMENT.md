...
```
*This is your temporary **Backend URL**.*
...
*Note: Replace `https://` with `wss://` for the WS_URL variable.*
...
3.  **Update Frontend**:
    ...
    *   *(Alternatively, use a persistent Cloudflare Tunnel domain to avoid updating variables every time).*
