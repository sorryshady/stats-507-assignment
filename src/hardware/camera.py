...
class CameraHandler:
    ...
    def __init__(self, device_id: int = CAMERA_DEVICE_ID, test_mode: bool = False, 
                 test_video_path: Optional[str] = None, test_images_dir: str = "test_images",
    ...
    def _initialize_camera(self):
        ...
        try:
            ...
            logger.info(f"Camera {self.device_id} initialized: {CAMERA_WIDTH}x{CAMERA_HEIGHT} @ {CAMERA_FPS} FPS")
    ...
    def _load_test_images(self):
        ...
        logger.warning("Using static images - consider using a video file for better testing")
    ...
    def read_frame(self) -> Tuple[bool, Optional[np.ndarray], Optional[str]]:
        ...
        if self.using_video:
            ...
            source_name = "camera" if self.test_mode else None  # Include source name in test mode
    ...
    def _read_test_video_frame(self) -> Tuple[bool, Optional[np.ndarray], Optional[str]]:
        ...
        video_name = Path(self.test_video_path).name if self.test_video_path else "test_video"
