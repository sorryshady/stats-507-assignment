...
def test_system_audio_output():
    ...
    try:
        ...
        result = subprocess.run(
            ['say', 'Testing system audio output'],
            capture_output=True,
            timeout=5
        )
...
def test_pyttsx3():
    ...
    try:
        ...
        if len(voices) > 0:
            ...
            enhanced_voices = [v for v in voices if 'enhanced' in v.id.lower() or 'premium' in v.id.lower()]
            female_voices = [v for v in voices if any(name in v.name.lower() for name in ['samantha', 'karen', 'victoria', 'zira'])]
    ...
    try:
        ...
        print("   You should hear: 'Hello, this is a test of the text to speech system.'")
        print("   Speaking now...")
        ...
        if response == 'y':
            ...
            if test_system_audio_output():
                ...
                print("   Consider using macOS 'say' command as fallback in the main app.")
                return False
            else:
                print("\n   Troubleshooting:")
